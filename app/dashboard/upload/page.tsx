    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="bg-card/40 border-border/50 backdrop-blur-md">
          ...
          <CardFooter>
            <Button className="w-full">Initialize Generation Pipeline</Button>
          </CardFooter>
        </Card>
        ...
        <div className="space-y-6">
          <Card className="bg-card/40 border-border/50 backdrop-blur-md">
            ...
            <CardContent className="pt-4 space-y-4">
              ...
              <Button variant="outline" className="w-full text-accent border-accent/50 hover:bg-accent/10">Find & Notify Substitute</Button>
            </CardContent>
          </Card>
