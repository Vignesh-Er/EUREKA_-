...
export const mockAccreditation: AccreditationDashboard = {
  readinessScore: 78,
  completedAreas: ['Curriculum Design', 'Faculty Qualifications'],
  pendingAreas: ['Student Outcomes', 'Facilities & Support'],
  gaps: ['Missing CO-PO mapping for 3 courses', 'Low attainment in ECE401']
}

export const mockAttainment: AttainmentLevel = {
  courseId: 'ECE401',
  overallAttainment: 85.5,
  coBreakdown: {
    'CO1': 90.0,
    'CO2': 82.5,
    'CO3': 88.0,
...
export const mockSyllabusCoverage: SyllabusCoverage = {
  courseId: 'ECE401',
  overallCoverage: 63.0,
  unitCoverage: {
    'Unit 1': 100.0,
    'Unit 2': 100.0,
    'Unit 3': 85.0,
...
export const mockComprehension: ComprehensionReport = {
  courseId: 'ECE401',
  coverage: 68.0,
  comprehension: 55.0,
  gap: 13.0,
...
export const mockTeachingScore: TeachingIntelligenceScore = {
  professorId: 'prof-1',
  compositeScore: 8.4,
  components: {
    syllabusCoverage: 9.0,
    studentComprehension: 7.5,
    feedbackSentiment: 8.0,
    activity: 9.5
  }
}

export const mockStaffTrends: StaffPerformanceOverview[] = [
  {
    professorId: 'prof-1',
    trend: 'improving',
    historicalScores: [7.8, 8.1, 8.4]
  },
  {
    professorId: 'prof-2',
    trend: 'stable',
    historicalScores: [9.1, 9.2, 9.1]
  }
]
