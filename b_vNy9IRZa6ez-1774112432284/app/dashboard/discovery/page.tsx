      ...
      <div className="flex flex-col md:flex-row gap-6 items-start justify-between">
        ...
        <Card className="bg-primary/5 border-primary/20 shrink-0 w-full md:w-80 relative overflow-hidden">
          ...
          <CardContent className="space-y-4 relative z-10">
            ...
            <Button className="w-full bg-primary/20 text-primary hover:bg-primary/30 border border-primary/20" onClick={() => toast({ title: "Track Adopted", description: `Enrollment initialized based on your current knowledge graph.` })}>
              Adopt this Track
            </Button>
          </CardContent>
        </Card>
...
<Button className="w-full mt-2 group/btn" variant="outline" onClick={() => toast({ title: "Connecting Node", description: "Spinning up remote Docker container for Virtual Lab..."})}>
                  Enter Virtual Lab 
