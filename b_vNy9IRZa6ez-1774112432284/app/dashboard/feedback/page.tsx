    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-destructive/5 border border-destructive/20 backdrop-blur-md">
            ...
            <CardContent>
              ...
              <Button variant="outline" size="sm" className="w-full text-destructive border-destructive/30 hover:bg-destructive/10" onClick={() => toast({ title: "Routed", description: "Issue escalated to the Procurement team." })}>
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <Button variant="ghost" className="w-full text-muted-foreground mt-4" onClick={() => toast({ title: "Loading", description: "Fetching historical insights..." })}>
            Load Older Feedback
          </Button>
