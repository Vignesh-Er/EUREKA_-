...
const studentNavItems: NavItem[] = [
  ...
  { title: 'Career Pathways', href: '/dashboard/career-pathways', icon: Route, badge: 'AI' },
  { title: 'Courses', href: '/dashboard/courses', icon: BookOpen },
  { title: 'Exam Prep', href: '/dashboard/exam-prep', icon: ClipboardCheck, badge: 'New' },
  ...
  { title: 'Placement Intelligence', href: '/dashboard/placement', icon: Briefcase },
  { title: 'Industry Connect', href: '/dashboard/industry-connect', icon: Users },
  { title: 'Parent Portal', href: '/dashboard/parent-portal', icon: Users },
  { title: 'Alumni Network', href: '/dashboard/alumni', icon: Network },
]
...
const professorNavItems: NavItem[] = [
  ...
  { title: 'Syllabus Coverage', href: '/dashboard/syllabus-coverage', icon: Map },
  { title: 'CO-PO Mapping', href: '/dashboard/co-po-mapping', icon: Network },
  { title: 'Student Feedback', href: '/dashboard/feedback', icon: MessageSquare },
  { title: 'Placement Intelligence', href: '/dashboard/placement', icon: Briefcase },
  { title: 'Tool Utilization', href: '/dashboard/tool-utilization', icon: Wrench },
  { title: 'Research & Grants', href: '/dashboard/research-grants', icon: FlaskConical },
  { title: 'Analytics', href: '/dashboard/analytics', icon: BarChart3 },
]

const adminNavItems: NavItem[] = [
  { title: 'Command Center', href: '/dashboard', icon: Home },
  { title: 'Executive Summary', href: '/dashboard/executive', icon: Landmark, badge: 'New' },
  { title: 'Accreditation', href: '/dashboard/accreditation', icon: ClipboardCheck },
  { title: 'Syllabus Overview', href: '/dashboard/syllabus-coverage', icon: Map },
  { title: 'Staff Performance', href: '/dashboard/staff-performance', icon: LineChart },
  { title: 'Dynamic Timetable', href: '/dashboard/timetable', icon: CalendarCheck },
  { title: 'Substitutes', href: '/dashboard/substitutes', icon: UsersRound, badge: 3 },
  { title: 'Feedback', href: '/dashboard/feedback', icon: MessageSquare, badge: 12 },
  { title: 'Placement Intelligence', href: '/dashboard/placement', icon: Briefcase },
  { title: 'Tool Utilization', href: '/dashboard/tool-utilization', icon: Wrench },
  { title: 'Industry Connect', href: '/dashboard/industry-connect', icon: Building },
  { title: 'Research & Grants', href: '/dashboard/research-grants', icon: FlaskConical },
  { title: 'Alumni Network', href: '/dashboard/alumni', icon: Handshake },
  { title: 'Procurement', href: '/dashboard/procurement', icon: ShieldCheck, badge: 2 },
  { title: 'Analytics', href: '/dashboard/analytics', icon: BarChart3 },
]
