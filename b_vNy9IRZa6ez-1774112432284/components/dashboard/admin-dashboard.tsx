          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-eureka-success">78%</p>
              </div>
              <CheckCircle2 className="w-8 h-8 text-eureka-success/20" />
            </div>
            <p className="text-xs text-muted-foreground mt-2">NBA Tier-1 Readiness</p>
          </CardContent>
        </Card>

        <Card className="bg-card border-primary/25 border-l-4 border-l-primary">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">Staff Intelligence</p>
                <p className="text-2xl font-bold text-primary">8.4</p>
              </div>
              <BarChart3 className="w-8 h-8 text-primary/20" />
            </div>
            <p className="text-xs text-muted-foreground mt-2">Avg Teaching AI Score</p>
          </CardContent>
        </Card>
      </div>
