  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-card border-primary/25 border-l-4 border-l-emerald-500">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
            ...
            <p className="text-xs text-muted-foreground mt-2">On track for semester</p>
          </CardContent>
        </Card>

        <Card className="bg-card border-primary/25 border-l-4 border-l-purple-500">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">CO-PO Mapped</p>
                <p className="text-2xl font-bold">100%</p>
              </div>
              <CheckCircle2 className="w-8 h-8 text-purple-500/20" />
            </div>
            <p className="text-xs text-muted-foreground mt-2">All active courses mapped</p>
          </CardContent>
        </Card>
      </div>
